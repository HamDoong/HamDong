...
class SettlementCreated(DomainEvent):
	def __init__(self, settlement_id, group_id, payer_user_id, receiver_user_id, amount_minor, currency, status):
		super().__init__(
			"SettlementCreated",
			{
...
class SettlementConfirmed(DomainEvent):
	def __init__(self, settlement_id, group_id, payer_user_id, receiver_user_id, amount_minor, currency, confirmed_by_user_id):
		super().__init__(
			"SettlementConfirmed",
			{
				"settlement_id": str(settlement_id),
...
class SettlementRejected(DomainEvent):
	def __init__(self, settlement_id, group_id, payer_user_id, receiver_user_id, amount_minor, currency, rejected_by_user_id, reason=None):
		data = {
			"settlement_id": str(settlement_id),
			"group_id": str(group_id),
			"payer_user_id": str(payer_user_id),
...
class SettlementCancelled(DomainEvent):
	def __init__(self, settlement_id, group_id, payer_user_id, receiver_user_id, amount_minor, currency, cancelled_by_user_id):
		super().__init__(
			"SettlementCancelled",
			{
				"settlement_id": str(settlement_id),
...
class DebtLedgerUpdated(DomainEvent):
	def __init__(self, group_id, currency, source_expense_id=None, source_settlement_id=None, entry_ids=None, status="ACTIVE"):
		data = {
			"group_id": str(group_id),
			"currency": currency,
			"status": status,
