    ...
    def _record_and_queue(self, *, reminder_type, group_id, target_user_id, reference_id, routing_key, event_type, data):
        ...
        with transaction.atomic():
            ...
            log = ReminderDispatchRepository.upsert_target(
                ...
                recipient_email=data.get("target_email") or data.get("receiver_email") or data.get("payer_email", ""),
        ...
        for balance in GroupBalanceSnapshot.objects.filter(net_balance_minor__lt=0):
            ...
            result = self._record_and_queue(
                ...
                data={
                    ...
                    "target_art_name": member.art_name_snapshot or member.email,
        ...
        for settlement in settlements:
            ...
            result = self._record_and_queue(
                ...
                data={
                    ...
                    "payer_art_name": (payer_member.art_name_snapshot if payer_member else str(settlement.payer_user_id)),
            ...
            for item in items:
                ...
                result = self._record_and_queue(
                    ...
                    data={
                        ...
                        "receiver_art_name": receiver.art_name_snapshot if receiver else str(item.receiver_user_id),
