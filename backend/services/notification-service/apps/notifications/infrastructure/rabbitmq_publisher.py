"""RabbitMQ publisher helpers for notification-service."""
...
from apps.notifications.infrastructure.repositories import OutboxRepository
...
class RabbitMQPublisher:
    def __init__(self, exchange=None):
        self.exchange = exchange or getattr(settings, "NOTIFICATION_RABBITMQ_EXCHANGE", "hamdong.notification")
    ...
    def publish_message(self, payload: dict, routing_key: str | None = None, exchange: str | None = None) -> bool:
        ...
        try:
            ...
            logger.exception("Failed to publish notification outbox message")
            return False
        finally:
