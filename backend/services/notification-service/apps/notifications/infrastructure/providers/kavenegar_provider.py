"""Legacy compatibility wrapper for the retired Kavenegar SMS provider."""
...
class KavenegarEmailProvider(EmailProvider):
    ...
    def send_email(self, recipient_email: str, subject: str, body: str) -> EmailSendResult:
        return EmailSendResult(
            ...
            error_message="Kavenegar is not supported after the email migration. Configure EMAIL_PROVIDER=smtp or EMAIL_PROVIDER=fake.",
            raw_response={"error": "provider_disabled"},
        )


# Backwards-compatible alias retained for old imports.
KavenegarSmsProvider = KavenegarEmailProvider
