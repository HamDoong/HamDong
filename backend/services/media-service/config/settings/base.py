...
IDENTITY_JWKS_URL = os.getenv("IDENTITY_JWKS_URL", "http://identity-service:8000/api/v1/auth/.well-known/jwks.json")
IDENTITY_PUBLIC_KEY_PATH = os.getenv("IDENTITY_PUBLIC_KEY_PATH", "/app/keys/public.pem")
