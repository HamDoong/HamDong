...
PROFILE_DISPLAY_NAME_MIN_LENGTH = env.int("PROFILE_DISPLAY_NAME_MIN_LENGTH", default=2)
PROFILE_DISPLAY_NAME_MAX_LENGTH = env.int("PROFILE_DISPLAY_NAME_MAX_LENGTH", default=150)
PROFILE_CITY_MAX_LENGTH = env.int("PROFILE_CITY_MAX_LENGTH", default=150)
PROFILE_BIO_MAX_LENGTH = env.int("PROFILE_BIO_MAX_LENGTH", default=500)
PROFILE_MAX_AGE_YEARS = env.int("PROFILE_MAX_AGE_YEARS", default=120)
